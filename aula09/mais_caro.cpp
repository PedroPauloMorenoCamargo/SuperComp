...
double mochila_cara(vector<Item>& itens, double capacidade, vector<int>& itensSelecionados) {
...
int main(int argc, char const *argv[]) {
    ...
    double valorMaximo = mochila_cara(itens, capacidade, itensSelecionados);
